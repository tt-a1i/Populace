...
export function FirstRunGuide({ enabled }: FirstRunGuideProps) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 w-[min(24rem,calc(100vw-2rem))] rounded-xl border border-cyan-300/20 bg-slate-950/92 p-5 shadow-[0_24px_80px_rgba(8,15,31,0.58)] backdrop-blur">
